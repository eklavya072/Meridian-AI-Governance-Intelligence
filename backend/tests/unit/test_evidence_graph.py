...
def test_evidence_graph_with_document_chunks():
    ...
    doc_chunks = [
        {"chunk_id": "c1", "text": "the system discloses all relevant information to users",
         "source_framework": "doc", "page_number": 1},
    ]
...
def test_evidence_graph_deduplication():
    ...
    chunks = [
        {"chunk_id": "c1", "text": "identical text that is long enough to pass the min length filter for sure now", "source_framework": "doc1"},
        {"chunk_id": "c2", "text": "identical text that is long enough to pass the min length filter for sure now", "source_framework": "doc2"},
    ]
...
def test_evidence_graph_quality_factors():
    ...
    doc_chunks = [
        {"chunk_id": "c1", "text": "A" * 200, "source_framework": "doc1",
         "similarity_score": 0.9},
        {"chunk_id": "c2", "text": "B" * 200, "source_framework": "doc2",
         "similarity_score": 0.8},
    ]
    fw_chunks = [
        {"chunk_id": "c3", "text": "C" * 200, "source_framework": "fw1",
...
def test_evidence_graph_source_diversity():
    ...
    chunks = [
        {"chunk_id": "c1", "text": "detailed policy analysis text that discusses transparency requirements for AI governance frameworks across multiple jurisdictions and sectors and is definitely long enough", "source_framework": "doc1"},
        {"chunk_id": "c2", "text": "detailed policy analysis text that discusses accountability standards for AI governance frameworks across multiple jurisdictions and sectors and is definitely long enough", "source_framework": "doc2"},
        {"chunk_id": "c3", "text": "detailed policy analysis text that discusses fairness guidelines for AI governance frameworks across multiple jurisdictions and sectors and is definitely long enough", "source_framework": "fw1"},
    ]
    graph = builder.build_graph("TestDim", chunks, [])
...
def test_evidence_graph_reranker_score_priority():
    ...
    chunks = [
        {"chunk_id": "c1", "text": "detailed text for analysis of something important",
         "source_framework": "doc1", "reranker_score": 0.95, "rrf_score": 0.5},
    ]
    graph = builder.build_graph("TestDim", chunks, [])
    assert graph.evidence_quality_score > 0.0
